...
CIKTI_FORMATLARI = ["json", "html", "csv", "markdown", "sarif", "bloodhound"]

VARSAYILAN_CLOUDTRAIL_GUN = 7
VARSAYILAN_THREAD_SAYISI = 5
VARSAYILAN_ONBELLEK_SURESI = 24
VARSAYILAN_HIZLI_VEKTOR_SAYISI = 15

DESTEKLENEN_BULUTLAR = ["aws", "gcp", "azure"]
